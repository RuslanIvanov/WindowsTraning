...
//////////////////////////////////////////////////////////////////////
	...
	//Отв:
	//  объекты с, s, r уже уничтожены , с virtual деструк. в данном случае разницы нет 
	stop
	...
	//Задание 6*. В чем заключается отличие 1) и 2)
	{
		...
		//1)  не массив указателей из 10 эл. а память выделена под sizeof(Rect)*10, конструктор по умолчанию
		//2) ---//---
...
//////////////////////////////////////////////////////////////////////
...

	{
		...
		r.Shape::WhereAmI(); // на этапе компиляции явно сказано компилятору что вызвать
		p->Shape::WhereAmI();
	stop	
	}
//*/
